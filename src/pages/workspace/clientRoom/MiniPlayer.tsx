...
import { formatDuration } from '../../../utils/clientRoom.helpers';

interface MiniPlayerProps {
    playingTrack: ClientTrackItem | null;
    isPlaying: boolean;
    isMuted: boolean;
    currentTime: number;
    duration: number;
...
export const MiniPlayer: React.FC<MiniPlayerProps> = ({
    ...
    return (
        <div className="fixed bottom-0 left-0 right-0 z-[9999]">
            {/* Main Player Bar */}
            <div className="bg-gradient-to-t from-black/95 via-black/90 to-black/85 backdrop-blur-2xl border-t border-cyan-800/50 shadow-2xl shadow-cyan-900/30">
                <div className="w-full px-4 py-3">
                    <div className="flex items-center gap-4">
                        {/* Volume Control - Bên trái nhất */}
                        <div className="relative flex-shrink-0">
                            {showVolumeSlider && (
                                <div className="absolute bottom-full mb-2 left-0 bg-black/90 backdrop-blur-xl border border-cyan-800/50 rounded-lg p-3 shadow-xl">
                                    <input
                                        type="range"
                                        min="0"
                                        max="1"
                ...
                {/* Track Info */}
                        <div className="flex items-center gap-3 flex-shrink-0">
                            <div className="flex-shrink-0 w-14 h-14 rounded-xl bg-gradient-to-br from-cyan-600 via-blue-600 to-cyan-600 flex items-center justify-center shadow-lg shadow-cyan-500/30 relative overflow-hidden">
                                <div className="absolute inset-0 bg-gradient-to-br from-cyan-400/20 to-blue-400/20 animate-pulse" />
                                <Music size={22} className="text-white relative z-10 drop-shadow-[0_0_8px_rgba(6,182,212,0.8)]" />
                            </div>
                            <div className="min-w-0">
                                <h4 className="text-white font-bold text-sm truncate max-w-[200px] drop-shadow-[0_0_4px_rgba(6,182,212,0.5)]">
                        ...
                        <div className="flex items-center gap-2 flex-shrink-0">
                            ...
                            <button
                                ...
                                className="w-12 h-12 mx-3 rounded-full bg-gradient-to-br from-cyan-600 to-cyan-500 hover:from-cyan-500 hover:to-cyan-400 flex items-center justify-center text-white transition-all shadow-lg shadow-cyan-500/40 hover:scale-110 active:scale-95"
                            >
                            ...
                            <div className="relative">
                                <button
                                    ...
                                    className={`w-10 h-10 rounded-full flex items-center justify-center text-gray-300 hover:text-white transition-all ${
                                        playbackSpeed !== 1
                                            ? 'bg-cyan-600/60 hover:bg-cyan-500/60 text-cyan-200'
                                ...
                                {showSpeedMenu && (
                                    <div
                                        ref={speedMenuRef}
                                        className="absolute bottom-full mb-2 left-1/2 transform -translate-x-1/2 bg-black/90 backdrop-blur-xl border border-cyan-800/50 rounded-lg p-2 shadow-xl min-w-[120px]"
                                    >
                    ...
                    <button
                                                ...
                                                className={`w-full px-4 py-2 text-sm rounded-md transition-all text-left ${
                                                    playbackSpeed === speed
                                                        ? 'bg-cyan-600/60 text-cyan-200 font-semibold'
            ...
            {showExpanded && (
                <div className="bg-black/80 backdrop-blur-xl border-t border-cyan-800/30">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div className="flex items-center gap-3">
                                {isMuted || volume === 0 ? (
                                    ...
                                    <Sparkles size={18} className="text-cyan-300 flex-shrink-0" />
                                )}
                                    ...
                                    {playbackSpeeds.map((speed) => (
                                        <button
                                            ...
                                            className={`px-3 py-1 rounded-md text-xs font-medium transition-all ${
                                                playbackSpeed === speed
                                                    ? 'bg-cyan-600 text-cyan-200 shadow-lg shadow-cyan-500/30'
                            ...
                            <div className="flex items-center gap-3 text-sm">
                                ...
                                <div className="text-cyan-300 font-semibold">{playbackSpeed}x</div>
                                {isLooping && (
                                    <>
