      ...
      <div className="w-full max-w-md bg-dark-surface rounded-2xl p-6 md:p-8 shadow-2xl max-h-[95vh]">
        ...
        <div className="text-center mb-8">
          <h2 className="text-3xl font-bold mb-2 text-text-primary">
            Chào mừng bạn đến với Workbench
          </h2>
        ...
        <form className="space-y-6" onSubmit={handleLogin}>
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full py-3 px-4 rounded-lg font-semibold text-white bg-accent transition-all duration-200 hover:bg-violet-700 disabled:opacity-50"
          >
